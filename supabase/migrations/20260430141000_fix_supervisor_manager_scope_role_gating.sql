-- Fix supervisor scorecards returning empty manager scope when hierarchy edges exist
-- but manager users do not have an explicit `manager` row in user_roles.
-- Scope authority should come from sales_hierarchy_edges.

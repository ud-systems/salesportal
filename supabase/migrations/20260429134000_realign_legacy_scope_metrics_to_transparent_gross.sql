-- Realign legacy KPI RPCs to transparent gross logic:
-- - Include all financial statuses (paid/pending/refunded/voided/etc.)
-- - Exclude only test orders
-- - Preserve existing scope and period behavior

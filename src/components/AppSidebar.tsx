...
const oversightNav: ({ title: string; url: string; icon: typeof LayoutDashboard; capability?: AppCapability })[] = [
  ...
  { title: "Orders", url: "/orders", icon: ShoppingCart },
  { title: "Products", url: "/products", icon: Package },
  { title: "Collections", url: "/collections", icon: FolderTree, capability: "view_procurement_pages" },
  { title: "Purchase Orders", url: "/purchase-orders", icon: ClipboardList, capability: "view_procurement_pages" },
  { title: "Inventory", url: "/inventory", icon: Boxes },

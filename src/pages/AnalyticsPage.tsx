...
import { ShoppingCart, Users, FileDown, FileText, LayoutList, Info, ChartNoAxesCombined } from "lucide-react";
...
import {
  ...
  fetchReportData,
  rowsToCsv,
  SHOPIFY_REPORT_ATTRIBUTION_NOTE,
...
export default function AnalyticsPage() {
  ...
  const orders = analytics?.orders_total ?? 0;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="card-float p-4 sm:p-5">
              <div className="flex items-center justify-between gap-2 mb-3 sm:mb-4">
                <h3 className="font-heading font-semibold text-foreground">Total sales trend</h3>
                  ...
                  <ResponsiveContainer key={`revenue-${chartRenderKey}`} width="100%" height={220} minWidth={0} minHeight={220}>
                    ...
                    <RechartsTooltip
                      formatter={(v: number, _name, item) => {
                        ...
                        return [formatOrderMoney(v, null, currency), "Total sales"];
                      }}
